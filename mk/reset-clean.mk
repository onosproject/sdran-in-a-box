...
reset-atomix:
	...
	kubectl delete crd -n kube-system $$(kubectl get crd --all-namespaces | grep atomix | awk '{print $$1}') || true
	cd $(M); rm -f atomix

reset-onos-op:
	helm uninstall onos-operator -n kube-system || true
	kubectl delete crd -n kube-system $$(kubectl get crd --all-namespaces | grep onos | awk '{print $$1}') || true
